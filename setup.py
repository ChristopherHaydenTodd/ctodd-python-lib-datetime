...
def main():
    ...
    setup(
        name="ctodd-python-lib-datetime",
        version=version,
        python_requires=">3.0,<3.7",
        description=("Python utilities used for interacting with Python DateTime Objects"),
        url="https://github.com/ChristopherHaydenTodd/ctodd-python-lib-datetime",
        author="Christopher H. Todd",
        author_email="Christopher.Hayden.Todd@gmail.com",
        classifiers=["Programming Language :: Python"],
        keywords=["python", "libraries", "date", "time", "timezones", "epoch"],
        packages=packages,
